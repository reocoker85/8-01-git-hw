...
Лог Fail2Ban показывает информацию о попытках входа по ssh и блокировке по ip адресу , в случае 6 неудавшихся попыток логина, после которых происходит блокировка согласно правилу maxretry. 
